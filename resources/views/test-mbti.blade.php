        ...
        <div class="w-100 d-flex flex-column justify-content-center align-items-center">
            ...
            <div class="d-flex flex-column gap-3 bg-white rounded-5 p-5 m-5 shadow mt-4"
                ...
                <div class="input-container" style="margin-top: 30px;">
                    ...
                    <label class="btn-label btn btn-outline-primary" for="btn-check-setuju">
                ...
                <div class="input-container" style="margin-top: 10px;">
                    ...
                    <label class="btn-label btn btn-outline-primary" for="btn-check-tidak-setuju">
                        <i class="em em-sweat" aria-role="presentation" aria-label="FACE WITH COLD SWEAT"></i> Tidak
                        Setuju
                    </label>
                </div>
