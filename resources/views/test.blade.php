    ...
    <div class="test-body">
        ...
        <div class="container test-grid d-flex flex-column flex-md-row justify-content-center my-5 gap-5">
            <div
                ...
                <a class="btn-link d-flex align-items-center justify-content-center" href="/minat-bakat">
            ...
            <div
                ...
                <a class="btn-link d-flex align-items-center justify-content-center" href="/mbti">
