                ...
                <form action="{{ route('users.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 font-raleway">
                        ...
                        <input type="text"
                            ...
                            value="{{ old('username') }}" placeholder="Masukkan username" id="username"
                            name="username">
                        @error('username')
                    ...
                    <div class="mb-3 font-raleway">
                        ...
                        <input type="email" class="form-control rounded-2 mt-2 @error('email') is-invalid @enderror"
                            value="{{ old('email') }}" placeholder="Masukkan email" id="email" name="email">
                        @error('email')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3 font-raleway">
                        <label for="password" class="form-label fw-600 m-0">Confirm Password :</label>
                        <input type="password"
                            class="form-control rounded-2 mt-2 @error('password') is-invalid @enderror"
                            value="{{ old('password') }}" placeholder="Masukkan password" name="confirm-password">
                        @error('password')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="mb-3 font-raleway">
                        <label for="password" class="form-label fw-600 m-0">Role :</label>
